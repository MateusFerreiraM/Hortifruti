...
```bash
git clone https://github.com/MateusFerreiraM/Hortifruti.git
cd hortifruti
```
...
Este projeto está licenciado sob a Licença MIT - veja o arquivo [LICENSE](LICENSE) para mais detalhes.# 🍏 Hortifruti JH - Gestão e PDV
